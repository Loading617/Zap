...
import com.loading.tools.FORCE_PLAY_ALL_AUDIO
import com.loading.tools.FORCE_PLAY_ALL_VIDEO
import com.loading.tools.KEY_APP_THEME
import com.loading.tools.KEY_CURRENT_MAJOR_VERSION
import com.loading.tools.KEY_CURRENT_SETTINGS_VERSION
import com.loading.tools.KEY_VIDEO_CONFIRM_RESUME
import com.loading.tools.SCREENSHOT_MODE
import com.loading.tools.Settings
import com.loading.tools.VIDEO_HUD_TIMEOUT
import com.loading.tools.coerceInOrDefault
import com.loading.tools.putSingle
import com.loading.tools.toInt
import com.loading.zap.gui.onboarding.ONBOARDING_DONE_KEY
import com.loading.zap.iszap
import java.io.File
...
object VersionMigration {
    ...
    val currentMajorVersion = if (isZAP1()) 4 else 3
     ...
     */
    private fun migrateToZap1(settings: SharedPreferences) {
        Log.i(this::class.java.simpleName, "Migration to ZAP 1")
